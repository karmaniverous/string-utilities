...
/**
 * Tagged template meta-function Non-stringifiable to Default:_ returns tagged template function that replaces any expression that has no `toString` property with a default value.
 *
